...
class Topic3Scene extends Scene {
  constructor(){
    super('topic3-intro')
  }
  ...
  create(){
    ...
    const title = this.add.dom(0, 0, 'div', null, 'Topic 3').setClassName('title');
  ...
  createProduceItButton(){
    ...
    .addListener('click')
    .on('click', function (event) {
      nextScene = 'topic3-intro-animation';
      this.removeListener('click');
    });
  }
}

export default Topic3Scene
